...
<body>
    <main class="legal-document">
        ...
        <h2 class="section-heading">1. WHAT INFORMATION DO WE COLLECT?</h2>
        ...
        <div class="notice">
            <strong>Important:</strong> We securely store the data uploaded by users to our platform within Amazon Web Services, ensuring its confidentiality and integrity. Users have the option to delete their data at any point, inclusive of both the data uploaded and chat messages. Unlike other AI services, your data and chats are never sent to BFL to be used for model training purposes.
        </div>

        <p><strong>Sensitive Information.</strong> We do not process sensitive information.</p>

        <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Stripe. You may find their privacy notice link(s) here: <a href="https://stripe.com/privacy" target="_blank">https://stripe.com/privacy</a>.</p>
        ...
        <h2 class="section-heading">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        ...
        <h2 class="section-heading">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        <p><strong>In Short:</strong> We only process your personal information when we believe it is necessary and we have a valid legal reason to do so under applicable law.</p>

        <p>If you are located in the EU or UK, this section applies to you. We may rely on the following legal bases to process your personal information:</p>
        <ul>
        ...
        <h2 class="section-heading">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        <p><strong>In Short:</strong> We may share information in specific situations described in this section.</p>
        ...
        <ul>
            ...
            <li><strong>Service Providers:</strong> We may share your information with third-party vendors and service providers who perform services for us.</li>
        </ul>

        <h2 class="section-heading">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
        <p><strong>In Short:</strong> We are not responsible for the safety of any information that you share with third parties that we may link to or who advertise on our Services.</p>

        <p>The Services may link to third-party websites, online services, or mobile applications. Accordingly, we do not make any guarantee regarding any such third parties, and we will not be liable for any loss or damage caused by the use of such third-party websites, services, or applications.</p>

        <h2 class="section-heading">6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
        <p><strong>In Short:</strong> We may use cookies and other tracking technologies to collect and store your information.</p>

        <p>We may use cookies and similar tracking technologies to access or store information. You can refuse certain cookies by adjusting your browser settings.</p>

        <h2 class="section-heading">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        ...
        <h2 class="section-heading">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        ...
        <h2 class="section-heading">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <p><strong>In Short:</strong> You have rights that allow you greater access to and control over your personal information.</p>
        ...
        <p><strong>Withdrawing your consent:</strong> If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time by contacting us at <a href="mailto:geoava@gmail.com">geoava@gmail.com</a>.</p>
        ...
        <h2 class="section-heading">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        ...
        <h2 class="section-heading">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        ...
        <p>California Civil Code Section 1798.83 permits our users who are California residents to request and obtain from us, once a year and free of charge, information about categories of personal information we disclosed to third parties for direct marketing purposes.</p>
        ...
        <p>To exercise these rights, you can contact us by email at <a href="mailto:geoava@gmail.com">geoava@gmail.com</a>.</p>

        <h2 class="section-heading">12. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        ...
        <p>Under the Virginia Consumer Data Protection Act (CDPA), you have rights regarding your personal data. We have not sold any personal data to third parties for business or commercial purposes.</p>

        <h2 class="section-heading">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        ...
        <h2 class="section-heading">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
        <p>If you have questions or comments about this notice, you may email us at <a href="mailto:geoava@gmail.com">geoava@gmail.com</a> or contact us by post at:</p>
        
        <address>
            IP Avaliani G.M.<br>
            David Aghmashenebeli Avenue 151A<br>
            Tbilisi, Georgia
        </address>

        <h2 class="section-heading">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
        <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us at <a href="mailto:geoava@gmail.com">geoava@gmail.com</a>.</p>

        <h2 class="section-heading">16. DATA PRIVACY & SECURITY</h2>
        
        <div class="notice">
            <strong>InteriorDesign Bot utilizes enterprise-grade best practices to protect our customers' data.</strong> We take our data privacy and security obligations seriously. Our platform, processes, and systems are designed to protect our users and their data.
        </div>

        <p><strong>Data Security</strong><br>
        We take the security of your data seriously. We implement appropriate technical, administrative, and physical safeguards to protect your data from unauthorized access, disclosure, alteration, or destruction. Data uploaded to our platform is protected by encryption at the storage layer using the Advanced Encryption Standard (AES) algorithm, AES-256.</p>

        <p><strong>Data Retention</strong><br>
        We will retain your data only for as long as necessary to fulfill the purposes for which it was collected or as required by applicable laws and regulations. Upon your request or termination of your account, we will delete or anonymize your data unless retention is necessary to comply with legal obligations. Files uploaded and conversations can be deleted by the user at any point.</p>

        <p><strong>Data Sharing and Disclosure</strong><br>
        We will not sell, rent, trade, or otherwise share your data with third parties for marketing purposes without your explicit consent. In order to enhance the functionality and user experience of our app, we share files uploaded via our services with BFL. This data is used solely for the purpose of generating relevant code/outputs and is not used for any other purposes. The data uploaded to BFL is aggregated and anonymized and is NOT used to train the AI model.</p>

        <p><strong>Third-Party Services</strong><br>
        We build on infrastructure with Amazon Web Services (AWS), BFL, and other service providers, which provide industry-leading security, privacy, operation monitoring, and compliance.</p>
    </main>
</body>
</html>
