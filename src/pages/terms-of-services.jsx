...
<body>
    <main class="legal-document">
        ...
        <div class="notice">
            <strong>IMPORTANT: PLEASE READ THESE TERMS CAREFULLY.</strong> BY ACCESSING OR USING THE SITE, YOU AGREE TO BE BOUND BY THESE TERMS. IF YOU DO NOT AGREE WITH ANY PART OF THESE TERMS, YOU MUST NOT USE THE SITE.
        </div>

        <h2 class="section-heading">1. AGREEMENT TO TERMS</h2>
        <p>These Terms of services constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Individual Entrepreneur G.M. Avaliani ("Company," “we," “us," or “our”), concerning your access to and use of the Interiordesignbot.com website as well as any other media form, media channel, mobile website, or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Georgia and have our registered office at David Aghmashenebeli Avenue 151A, Tbilisi, Georgia, TIN 302313075.</p>
        ...
        <h2 class="section-heading">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        ...
        <h2 class="section-heading">3. USER REPRESENTATIONS</h2>
        ...
        <h2 class="section-heading">4. USER REGISTRATION</h2>
        <p>You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>

        <h2 class="section-heading">5. PROHIBITED ACTIVITIES</h2>
        ...
        <h2 class="section-heading">6. USER GENERATED CONTRIBUTIONS</h2>
        ...
        <h2 class="section-heading">7. CONTRIBUTION LICENSE</h2>
        ...
        <h2 class="section-heading">8. SUBMISSIONS</h2>
        ...
        <h2 class="section-heading">9. SITE MANAGEMENT</h2>
        ...
        <h2 class="section-heading">10. PRIVACY POLICY</h2>
        <p>We care about data privacy and security. Please review our Privacy Policy: https://www.interiordesignbot.com/privacy-policy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in Georgia. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Georgia, then through your continued use of the Site, you are transferring your data to Georgia, and you agree to have your data transferred to and processed in Georgia.</p>

        <h2 class="section-heading">11. TERM AND TERMINATION</h2>
        ...
        <h2 class="section-heading">12. MODIFICATIONS AND INTERRUPTIONS</h2>
        ...
        <h2 class="section-heading">13. GOVERNING LAW</h2>
        <p>These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of Georgia applicable to agreements made and to be entirely performed within Georgia, without regard to its conflict of law principles.</p>

        <h2 class="section-heading">14. DISPUTE RESOLUTION</h2>
        <h3>Informal Negotiations</h3>
        <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms of Use (each "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>

        <h3>Binding Arbitration</h3>
        <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the rules of the Georgian Arbitration Association. Your arbitration fees and your share of arbitrator compensation shall be governed by the respective rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing. Except where otherwise required by the applicable rules or applicable law, the arbitration will take place in Tbilisi, Georgia.</p>
        <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the courts located in Tbilisi, Georgia, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such courts.</p>
        ...
        <h2 class="section-heading">15. CORRECTIONS</h2>
        ...
        <h2 class="section-heading">16. DISCLAIMER</h2>
        ...
        <h2 class="section-heading">17. LIMITATIONS OF LIABILITY</h2>
        ...
        <h2 class="section-heading">18. INDEMNIFICATION</h2>
        ...
        <h2 class="section-heading">19. USER DATA</h2>
        <p>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

        <h2 class="section-heading">20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        ...
        <h2 class="section-heading">21. MISCELLANEOUS</h2>
        ...
        <h2 class="section-heading">22. REFUNDS</h2>
        ...
        <p>Eligibility for a refund also depends on the number of requests made using our services. If you have sent more than 10 total requests across any of our products during this period, you will not be eligible for a refund. This policy is in place because extensive usage incurs significant costs which impact the sustainability of our offerings.</p>
        <p>To request a refund, please contact our support team at geoava@gmail.com. Our team will review your request and inform you of the approval or rejection of your refund based on the conditions mentioned above.</p>
    </main>
</body>
</html>
        <h1>Terms of services</h1>
