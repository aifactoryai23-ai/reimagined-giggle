...
export default function ProcessingView() {
  ...
  const processing = t("processing", { returnObjects: true }) || {};
  const steps = Array.isArray(processing.steps) ? processing.steps : [];
  ...
  return (
    ...
    <ElectricBorder>
      <Card className="p-8 text-center">
        ...
        <h2 className="text-3xl font-bold mb-3">{processing.title}</h2>
        <p className="text-xl text-gray-600 mb-8">{processing.subtitle}</p>
        ...
        <p className="text-sm text-gray-500 mt-8">{processing.duration}</p>
      </Card>
    </ElectricBorder>

      <Card className="p-6">
        <div className="text-center mb-4">
          <h3 className="text-lg font-semibold text-gray-800">{processing.visualTitle}</h3>
          <p className="text-sm text-gray-600 mb-2">{processing.visualSubtitle}</p>
          <p className="text-base text-gray-500">{processing.visualAction}</p>
        </div>
